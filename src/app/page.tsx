...
const quickStartSteps = [
  ...
  {
    icon: FileSearch,
    title: "2. Добавьте вакансию",
    description: "Вставьте текст или ссылку на вакансию, на которую откликаетесь.",
  },
  {
    icon: Sparkles,
    title: "3. Получите результат",
    description: "Адаптированное резюме с комментариями, что и почему изменено, плюс сопроводительное письмо.",
  },
]
